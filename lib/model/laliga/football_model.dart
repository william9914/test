class FootballMatchss {

  Fixture fixture;
  Team home;
  Team away;
  Goal goal;
  FootballMatchss(this.fixture, this.home, this.away, this.goal);

  factory FootballMatchss.fromJson(Map<String, dynamic> json){
    return FootballMatchss(
