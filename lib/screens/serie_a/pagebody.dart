...
import 'package:test_app/screens/serie_a/matchtile.dart';
import 'package:test_app/screens/serie_a/teamstat.dart';
import 'package:test_app/screens/serie_a/goalstat.dart';

Widget PageBody(List<FootballMatchs> allmatches){
  return Column(
    children: [
      Expanded(
          flex: 2,
