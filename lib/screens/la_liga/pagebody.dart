...
import 'package:test_app/screens/la_liga/matchtile.dart';
import 'package:test_app/screens/la_liga/teamstat.dart';
import 'package:test_app/screens/la_liga/goalstat.dart';

Widget PageBody(List<FootballMatchss> allmatches){
  return Column(
    children: [
      Expanded(
        flex: 2,
